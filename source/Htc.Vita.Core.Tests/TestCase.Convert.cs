...
namespace Htc.Vita.Core.Tests
{
    ...
    {
        [Fact]
        public void Convert_0_FromBase64String()
        {
        ...
        [Fact]
        public void Convert_1_FromHexString()
        {
            var bytes1 = Encoding.UTF8.GetBytes("123");
            Assert.NotNull(bytes1);
        ...
        [Fact]
        public void Convert_3_ToDateTime()
        {
        ...
        [Fact]
        public void Convert_4_ToTimestampInMilli()
        {
