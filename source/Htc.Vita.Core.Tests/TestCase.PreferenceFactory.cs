...
namespace Htc.Vita.Core.Tests
{
    ...
    {
        [Fact]
        public void PreferenceFactory_Default_0_GetInstance()
        {
        ...
        [Fact]
        public void PreferenceFactory_Default_1_GetInstance_WithType()
        {
        ...
        [Fact]
        public void PreferenceFactory_Default_2_LoadPreferences()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
        ...
        [Fact]
        public void Preference_Default_00_PutBool()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_01_PutDouble()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_02_PutFloat()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_03_PutInt()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_04_PutLong()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_05_PutString()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_06_ParseBool()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_06_ParseBool_WithDefault()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_07_ParseDouble()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_07_ParseDouble_WithDefault()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_08_ParseFloat()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_08_ParseFloat_WithDefault()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_09_ParseInt()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_09_ParseInt_WithDefault()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_10_ParseLong()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_10_ParseLong_WithDefault()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_11_ParseString()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_11_ParseString_WithDefault()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_12_Commit()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
        ...
        [Fact]
        public void Preference_Default_13_Clear()
        {
            var preferenceFactory = PreferenceFactory.GetInstance();
            Assert.NotNull(preferenceFactory);
            var preferences = preferenceFactory.LoadPreferences();
